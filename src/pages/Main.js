					...
					<div class="frame2">
						...
						<button type='button' onClick={()=>alert("hello!")} class="applebutton">
							<div class="buttoncont"> {/* logo + cont*/}
								...
								<p style={{color:'white',marginTop:'2px'}}>Apple 계정으로 로그인</p>
							</div> 
						</button>
						<button type='button' onClick={()=>alert("hello!")} class="kakaobutton">
							<div class="buttoncont">
								...
								<p style={{marginTop:'2px'}}>카카오톡으로 로그인</p>
							</div>
						</button>
						<button type='button' onClick={() => Open("http://ec2-3-35-151-197.ap-northeast-2.compute.amazonaws.com/oauth2/authorization/google")} class="googlebutton">
							<div class="buttoncont">
								<div class="logobackG">
									<svg width="24" height="24" viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
								...
								<p style={{marginTop:'2px'}}>Google 계정으로 로그인</p>
							</div>
						</button>
						<button type='button' onClick={()=>alert("hello!")} class="facebookbutton">
							<div class="buttoncont">
								...
								<p style={{color:'white',marginTop:'2px'}}>Facebook 계정으로 로그인</p>
							</div>
						</button>
						<Link to="/Email">
